...
function pk_sign(pk_algo, hash_algo, data, key) {
    ...
    var sign = k.sign(hash.digest(hash_algo).update(data).digest(), hash_algo);
...
function pk_verify(pk_algo, hash_algo, data, sign, key) {
    ...
    return k.verify(hash.digest(hash_algo).update(data).digest(), sign, hash_algo);
}
