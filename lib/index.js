...
function pk_sign(pk_algo, hash_algo, data, key) {
    ...
    if (this != 0) {
        if (k.curve != this)
            throw 'private key curve should be ' + this;
...
function pk_verify(pk_algo, hash_algo, data, sign, key) {
    ...
    if (this != 0) {
        if (k.curve != this)
            throw 'public key curve should be ' + this;
...
var signs = {
    ...
    'ES256K': pk_sign.bind('P-256K', 'EC', hash.SHA256),
    'ES384': pk_sign.bind('P-384', 'EC', hash.SHA384),
    'ES512': pk_sign.bind('p-521', 'EC', hash.SHA512),
    'SSM3': pk_sign.bind('sm2p256r1', 'SM2', hash.SM3)
};
...
var verifys = {
    ...
    'ES256K': pk_verify.bind('P-256K', 'EC', hash.SHA256),
    'ES384': pk_verify.bind('P-384', 'EC', hash.SHA384),
    'ES512': pk_verify.bind('P-521', 'EC', hash.SHA512),
    'SSM3': pk_verify.bind('sm2p256r1', 'SM2', hash.SM3)
};
